...
Breakdown: 
### [Thesis_25](https://github.com/awessel3/Thesis_25) - 2025 Undergraduate Research Honors Thesis 
Bayesian modeling of citizen-science (iNaturalist) observations to quantify phenological shifts across prairie species in the Willamette Valley–Puget Trough ecoregion. Includes data cleaning pipelines, hierarchical Bayesian models (R / brms), and reproducible analysis notebooks.
currently still in the works to make it publishing ready. 
- R, BRMS, ggplot2, tidyverse, version control, ...

### [OHW25](https://github.com/oceanhackweek/ohw25_proj_datadashboard_llm) - OceanHackWeek2025 Marine Data Science Hack
...
### [Bee Urbanization Mini Project](https://github.com/awessel3/Bee-Urbanization-BI410) 
...
### [Diez_Lab_Parks_Project](https://github.com/awessel3/Diez_Lab_Parks_Project) - Analysis / Data Cleaning Repo for Diez Lab Projects 
...
### [Past_projects](https://github.com/awessel3/Past_Projects/tree/main) - Repo for Past Projects 
...
[GIS project Salem Parks Project](https://github.com/user-attachments/files/22665421/Final_proj_GEOG482.pdf)
This project was completed in partnership with the City of Salem to explore ways to improve city walkability. The work continued beyond the course when I was invited to write the final report, which was published in June 2024.
The full report can be found [here](https://scholarsbank.uoregon.edu/items/caa9fdba-8605-4506-9b52-ab88405d726d)
- ArcGIS Pro

### Tableau Dashboard 
[Parks Project Tableau Dashboard](https://public.tableau.com/app/profile/ava.wessel/viz/TermProject_17422437298510/Dashboard1)
This project was completed in data science visualizations course in Winter 2025. using biodiversity datasets from the Diez Lab Parks Project to highlight patterns and differences across sites.
- Tableau 


<!--
**awessel3/awessel3** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
